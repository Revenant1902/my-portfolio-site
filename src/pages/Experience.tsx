      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl font-bold">Technical & AI</h2>
          </div>
        ...
        <div>
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl font-bold">Sales & Business Development</h2>
          </div>
        ...
        <div className="mt-16 card bg-gradient-to-r from-accent-teal/5 to-accent-blue/5">
          <h3 className="text-lg font-semibold mb-6">Combined Impact</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div>
              <div className="text-2xl font-bold gradient-text">~3,000</div>
              <div className="text-sm text-gray-400">Outbound Calls</div>
            </div>
            <div>
              <div className="text-2xl font-bold gradient-text">1,300+</div>
